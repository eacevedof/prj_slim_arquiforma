...
$xmlResponse->addOutput($xmlResponse->getOpenTag(XmlTagEnum::XML));
$xmlResponse->addOutput($xmlResponse->getOpenTagWithAttribute(XmlTagEnum::RESULT, XmlAttributeEnum::VERSION, ConstantEnum::TUNNEL_VERSION_13_21));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::E_I));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::SERVER_INFO, "10.5.22-MariaDB-1:10.5.22+maria~deb11-log"));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::M_I));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::NUM_ROW_RESULT, "1"));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::INSERTED_ID, "0"));
$xmlResponse->addOutput(1);
$xmlResponse->addOutput($xmlResponse->getOpenTagWithAttribute(XmlTagEnum::FIELD_INFORMATION, XmlAttributeEnum::COUNT, "1"));
$xmlResponse->addOutput($xmlResponse->getOpenTag(XmlTagEnum::FIELD));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::FIELD_NAME, "version()"));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::FIELD_TABLE));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::FIELD_MAX_LENGTH, "0"));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::FIELD_D));
$xmlResponse->addOutput($xmlResponse->getTagValue(XmlTagEnum::FIELD_TYPE, "varchar"));
$xmlResponse->addOutput($xmlResponse->getCloseTag(XmlTagEnum::FIELD));
$xmlResponse->addOutput($xmlResponse->getCloseTag(XmlTagEnum::FIELD_INFORMATION));
$xmlResponse->addOutput($xmlResponse->getOpenTagWithAttribute(XmlTagEnum::ROW_INFO, XmlAttributeEnum::COUNT, "1"));
$xmlResponse->addOutput($xmlResponse->getOpenTag(XmlTagEnum::ROW));
$xmlResponse->addOutput($xmlResponse->getTagWithAttribute(XmlTagEnum::COLUMN, "10.5.22-MariaDB-1:10.5.22+maria~deb11-log", XmlAttributeEnum::LENGTH, "41"));
$xmlResponse->addOutput($xmlResponse->getCloseTag(XmlTagEnum::ROW));
$xmlResponse->addOutput($xmlResponse->getCloseTag(XmlTagEnum::ROW_INFO));
$xmlResponse->addOutput($xmlResponse->getCloseTag(XmlTagEnum::RESULT));
$xmlResponse->addOutput($xmlResponse->getCloseTag(XmlTagEnum::XML));
//yogLog($xmlResponse->getOutput(), "eaf-output");
//die($output);
